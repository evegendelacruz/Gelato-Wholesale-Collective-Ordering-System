...
import { Camera, Eye, EyeOff, FileText, User, Briefcase } from 'lucide-react';
...
export default function ClientProfilePage() {
  ...
  const handleSaveChanges = async () => {
    ...
    // Update Supabase Auth password FIRST (this is what actually matters for login)
    if (formData.password) {
      ...
      // Only update the database field if you want to keep a record
      // Note: This field should NOT be used for authentication
  ...
  return (
    <div className="min-h-screen" style={{ fontFamily: '"Roboto Condensed"', backgroundColor: '#f5e6d3' }}>
      <ClientHeader />
      <div style={{ backgroundColor: '#f5ebe0', minHeight: '100vh', padding: '24px' }}>

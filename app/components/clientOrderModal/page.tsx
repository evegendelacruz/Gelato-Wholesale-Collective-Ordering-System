...
import { X, Search, Trash2, Check, Plus, ChevronDown, ChevronUp } from 'lucide-react';
          ...
          <div className="px-6 py-4 flex-shrink-0 border-b border-gray-200">
            ...
            <div className="flex items-center justify-center">
              <div className="flex items-center gap-3">
                ...
                <div className={`w-10 h-0.5 ${step >= 2 ? 'bg-orange-600' : 'bg-gray-300'}`}></div>
                ...
                <div className={`w-10 h-0.5 ${step >= 3 ? 'bg-orange-600' : 'bg-gray-300'}`}></div>
                <div className={`flex items-center gap-2 ${step >= 3 ? 'text-orange-600' : 'text-gray-400'}`}>
                  <div className={`w-7 h-7 rounded-full flex items-center justify-center text-sm font-medium ${step >= 3 ? 'bg-orange-600 text-white' : 'bg-gray-300'}`}>
                    3
                  </div>
            ...
            {step === 3 && (
              <div className="space-y-4">
                ...
                <div className="space-y-4 pb-4">
                  ...
                  <div className="sticky top-0 z-10 bg-white py-3 border-b border-gray-200 shadow-sm">
                    <div className="flex items-center justify-between">
                        ...
                        >
                          <div className="flex items-center gap-2 flex-1 min-w-0">
                            ...
                            {collapsedItems.has(index) && item.product_name && (
                              <div className="flex items-center gap-1 text-xs text-gray-600 truncate ml-1">
                                <span className="font-medium truncate">{item.product_name}</span>
                                <span className="text-gray-400">|</span>
                                <span>Qty: {item.quantity}</span>
                                <span className="text-gray-400">|</span>
                                <span className="text-orange-600 font-medium">S$ {item.subtotal.toFixed(2)}</span>
                              </div>
                            )}
                          </div>
